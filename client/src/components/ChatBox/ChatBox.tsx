    ...
    return (
        <div className={styles.container}>
            ...
            <p className={styles.notice}>
                Если вы видите ошибку <span className={styles.errorText}>"Failed to fetch"</span>, это может означать, что приложение "проснулось" после простоя.
                Пожалуйста, подождите 1–2 минуты и попробуйте снова — запуск может занять немного времени при бесплатном хостинге.
            </p>
